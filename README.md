...
[![godoc for RichardKnop/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/relychan/machinery/v1)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/relychan/machinery)](https://goreportcard.com/report/github.com/relychan/machinery)
[![GolangCI](https://golangci.com/badges/github.com/relychan/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for RichardKnop/machinery](https://sourcegraph.com/github.com/relychan/machinery/-/badge.svg)](https://sourcegraph.com/github.com/relychan/machinery?badge)
...
import (
  ...
  backendsiface "github.com/relychan/machinery/v2/backends/iface"
  brokersiface "github.com/relychan/machinery/v2/brokers/iface"
  locksiface "github.com/relychan/machinery/v2/locks/iface"
)
...
```sh
go get github.com/relychan/machinery/v2
```

If you want to use legacy v1 version, you still can:

```sh
go get github.com/relychan/machinery
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/relychan/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/relychan/machinery/v1/log` package:
...
import (
  ...
  "github.com/relychan/machinery/v1"
)
